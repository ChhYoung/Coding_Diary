/*
min dis between station 
max dis between hourse
smallest ave dis to house
smallest index num

N： num of house 1-N
M: num of loca of station  1-M
K: num of road connect to station and house
Ds: max swrice rang

// 距离房屋最远，但平均距离最小的
output the min and average dis between houses3
*/

/*
思路：对每个station用diji得到最短距离
    并求出其平均距离
*/
