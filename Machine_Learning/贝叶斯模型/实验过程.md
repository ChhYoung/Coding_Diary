...
##### &emsp;&emsp;&emsp;1.4 采用TF-IDF来提取特征 
...
if __name__ == '__main__':
    ...
    for i in range(10):
        ...
        #将[['words1',['words2'],...],['word_i',....]]转换为[‘string1’，‘str2’,....] 以便使用 CountVectorizer() 
...
```
> ###### 得到结果
>[0.5026455026455027, 0.6301587301587301, 0.6259259259259259, 0.6555555555555556, 0.6154761904761905, 0.7569444444444444, 0.8458333333333333, 0.5767195767195766, 0.7925925925925926, 0.6343537414965985]
较未使用的有所改善
